...
public class LogSystemUnit3 : MonoBehaviour
{
    static private float elapsedTime = 0f;
    private bool isRunning = false;
    public static LogSystemUnit3 instance;
    ...
    public void InitQuestionRecord()
    {
        ...
        {
        { "Q1", "台灣是由哪兩大板塊組成", "歐亞板塊 & 菲律賓海板塊" },
        { "Q2", "歐亞板塊隱沒入菲律賓海板塊位置", "東部" },
        { "Q3", "台灣西側海峽的名稱及其地質特徵", "台灣海峽、地質相對穩定" },
        { "Q4", "最有可能位於地震活動帶的區域", "花蓮縣" },
        { "Q5", "台灣西部平原主要由哪些岩石構成", "變質岩，受板塊擠壓影響" }
        };
    ...
    public void ExportAllToExcel()
{
    ...
    string mergedPath= Path.Combine(persistentPath, "單元三總報告.csv");
    ...
    private void Reset()
    {
        ...
        HintCount = 0;
        Debug.Log(GainedKnowledgePoints);
    ...
    public void AggregateTaskRows(int parentRowIndex)
    {
        ...
        string completionRate = totalPoints == 0
    ? "100%"
    : $"{Mathf.RoundToInt((float)totalGotPoints / totalPoints * 100)}%";
    ...
    public void SetPredictionResult(bool result)
    {
