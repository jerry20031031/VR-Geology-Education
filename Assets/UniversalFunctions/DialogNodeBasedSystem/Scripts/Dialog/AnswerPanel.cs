...
namespace cherrydev
{
    public class AnswerPanel : MonoBehaviour
    {
        ...
        private List<TextMeshProUGUI> buttonKey = new List<TextMeshProUGUI>();
        ...
        public void SetUpButtons(int maxAmountOfAnswerButtons)
        {
            for (int i = 0; i < maxAmountOfAnswerButtons; i++)
            {
                ...
                buttonKey.Add(answerButton.transform.Find("Hint").GetComponentInChildren<TextMeshProUGUI>());
            }
        }
        ...
        public TextMeshProUGUI GetButtonKeyByIndex(int index)
        {
