...
public class restrictyRight : MonoBehaviour
{
    ...
    //private outline22 outline22Script; // 用來存取 Outline22 腳本
    ...
    private void Awake()
    {
        ...
        //outline22Script = GetComponent<outline22>();
    ...
    {
        isMoving = true; // 開始移動
        /*if (outline22Script.enabled == false)
        {
        ...
        if (isMoving)
        {
            ...
            if (transform.position.x > movestopx)
            {
                if (transform.position.z > movestopz)
                {
                    ...
                    // 啟用 Outline22 腳本
                    /*if (outline22Script != null)
                    {
                        outline22Script.enabled = true; // 打勾
                    }*/
                    return;
                }
